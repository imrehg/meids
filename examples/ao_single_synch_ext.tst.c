 ...
 ***************************************************************************/
/** @note To work correctly only last channel should be used for triggering (DA_TRIG_3). */
...
int main(int argc, char *argv[])
{
	...
	printf("Hello, AO single synchronous start externally triggered test!\n");
	...
	for (i=0; i<4; ++i)
	{
		meIOSingleConfig(NoDev, NoSubDev + i, 0, 0, ME_REF_AO_GROUND, ME_TRIG_CHAN_SYNCHRONOUS, ME_TRIG_TYPE_EXT_DIGITAL, ME_TRIG_EDGE_RISING, ME_VALUE_NOT_USED);
...
EXIT:
	meClose(0);
	printf("Boodbye, AO single synchronous start externally triggered test!\n");
