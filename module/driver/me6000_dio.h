 ...
 * @file me6000_dio.h
 *
 * @brief The ME-6000 digital input/output subdevice class header file.
...
#  define me6000_DIO_CAPS				ME_CAPS_DIO_DIR_BYTE

/**
 * @brief The ME-6000 digital input/output subdevice class.
 */
