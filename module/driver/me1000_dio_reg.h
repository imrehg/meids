...
// The number of channels per DIO port.
#  define ME1000_DIO_NUMBER_CHANNELS	32
// The number of ports per ME-1000.
#  define ME1000_DIO_NUMBER_PORTS		4
...
#  define ME1000_DIO_MODE_SHIFT				2
