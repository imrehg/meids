...
//Interrupt mode.
#define ME8100_DIO_CTRL_MASK_MODE		(ME8100_DIO_CTRL_BIT_INTB_0 | ME8100_DIO_CTRL_BIT_INTB_1)
#define ME8100_DIO_CTRL_PATERN_MODE		ME8100_DIO_CTRL_BIT_INTB_0

//0-therdstate 1-normal operation
